...
public class HashMapEx4 {
	public static void main(String[] args) {
		...
		System.out.println(student.remove(3));//simple remove method works on key
		System.out.println(student.remove(9));//try removing key which does not exist then it will return null value
